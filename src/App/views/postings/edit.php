...
<h1 class="sr-only">Edit A Job Posting</h1>
    ...
    >
        ...
        <div class="min-h-20 px-6 py-4 space-y-2">
            <label
                    ...
                    class="inline-block text-base font-bold text-very-dark-blue cursor-pointer"
            >Company</label>
            <input
                    type="text"
                    name="company"
                    ...
                    value="<?php echo escape($posting['company'] ?? ''); ?>"
            />
        ...
        <div class="min-h-20 px-6 py-4 space-y-2">
            ...
            <input
                    ...
                    class="w-full px-4 py-3 text-base text-very-dark-blue caret-violet border-2 border-very-dark-blue/10 rounded-sm active:outline-none active:bg-violet/10 focus:outline-none focus:bg-violet/10 placeholder:text-very-dark-blue/50"
                    value="<?php echo escape($posting['position'] ?? ''); ?>"
            />
            ...
            <div class="space-y-3">
                <div class="flex items-center gap-x-4">
                    <input
                        ...
                        <?php echo $posting['contract'] === 'Full Time' ? 'checked' : ''; ?> />
                    <label
                ...
                <div class="flex items-center gap-x-4">
                    <input
                        ...
                        <?php echo $posting['contract'] === 'Part Time' ? 'checked' : ''; ?> />
                    <label
                ...
                <div class="flex items-center gap-x-4">
                    <input
                            ...
                            name="contract"
                            class="appearance-none size-6 bg-very-dark-blue/10 grid place-content-center cursor-pointer before:transition-transform before:duration-500 before:ease-[cubic-bezier(0.45, 1.8, 0.5, 0.75)] border-2 border-very-dark-blue rounded-full before:size-3 before:bg-violet before:rounded-full before:scale-0 checked:before:scale-100"
                        <?php echo $posting['contract'] === 'Internship' ? 'checked' : ''; ?> />
                    <label
        ...
        <div class="min-h-20 px-6 py-4 space-y-2">
            ...
            <input
                    ...
                    class="w-full px-4 py-3 text-base text-very-dark-blue caret-violet border-2 border-very-dark-blue/10 rounded-sm active:outline-none active:bg-violet/10 focus:outline-none focus:bg-violet/10 placeholder:text-very-dark-blue/50"
                    value="<?php echo escape($posting['location'] ?? ''); ?>"
            />
        ...
        <div class="min-h-20 px-6 py-4 space-y-2">
            ...
            <input
                    ...
                    class="w-full px-4 py-3 text-base text-very-dark-blue caret-violet border-2 border-very-dark-blue/10 rounded-sm active:outline-none active:bg-violet/10 focus:outline-none focus:bg-violet/10 placeholder:text-very-dark-blue/50"
                    value="<?php echo escape($posting['website'] ?? ''); ?>"
            />
        ...
        <div class="min-h-20 px-6 py-4 space-y-2">
            ...
            <textarea
                    ...
                    class="w-full min-h-36 px-4 py-3 text-base text-very-dark-blue caret-violet border-2 border-very-dark-blue/10 rounded-sm resize-none active:outline-none active:bg-violet/10 focus:outline-none focus:bg-violet/10 placeholder:text-very-dark-blue/50"
            ><?php echo escape($posting['description'] ?? ''); ?></textarea>
        ...
        <div class="min-h-20 px-6 py-4 space-y-2">
            ...
            <textarea
                    ...
                    class="w-full min-h-36 px-4 py-3 text-base text-very-dark-blue caret-violet border-2 border-very-dark-blue/10 rounded-sm resize-none active:outline-none active:bg-violet/10 focus:outline-none focus:bg-violet/10 placeholder:text-very-dark-blue/50"
            ><?php echo escape($posting['requirements'] ?? ''); ?></textarea>
        ...
        <div class="min-h-20 px-6 py-4 space-y-2">
            ...
            <textarea
                    ...
                    class="w-full min-h-36 px-4 py-3 text-base text-very-dark-blue caret-violet border-2 border-very-dark-blue/10 rounded-sm resize-none active:outline-none active:bg-violet/10 focus:outline-none focus:bg-violet/10 placeholder:text-very-dark-blue/50"
            ><?php echo escape($posting['role'] ?? ''); ?></textarea>
